...
- **crafting shaped** (`biomedical_processor.json`): `#bioforge:ingredients/minecraft/diamond`, `#bioforge:ingredients/minecraft/echo_shard`, `#bioforge:ingredients/minecraft/comparator`, [[Electronic Control Unit]], `#bioforge:ingredients/minecraft/redstone_block`, [[Precision Mechanism]] → 1 × Biomedical Processor.
...
- Used to produce: [[Area Contamination Scanner]], [[Pharma Mixer]], [[Vaccine Maker]].
...
- Registry ID: `bioforge:biomedical_processor`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/biomedical_processor`.
