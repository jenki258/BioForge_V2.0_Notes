...
- **blasting** (`black_steel_ingot.json`): process input → 1 × Black Steel Ingot.
- **crafting shapeless** (`black_steel_ingots_from_block.json`): [[Black Steel Block]] → 9 × Black Steel Ingot.
- **crafting shaped** (`black_steel_ingot_from_nuggets.json`): [[Black Steel Nugget]] → 1 × Black Steel Ingot.
...
- Used to produce: [[Black Steel Block]], [[Black Steel Nugget]], [[Black Steel Plate]].
...
- Registry ID: `bioforge:black_steel_ingot`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/black_steel_ingot`.
