...
- **crafting shaped** (`black_steel_blend.json`): `#bioforge:ingredients/minecraft/iron_ingot`, [[Activated Carbon]], `#bioforge:ingredients/minecraft/flint` → 4 × Black Steel Blend.
...
- Used to produce: [[Black Steel Ingot]].
...
- Registry ID: `bioforge:black_steel_blend`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/black_steel_blend`.
