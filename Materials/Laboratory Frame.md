...
- **crafting shaped** (`laboratory_frame.json`): [[Black Steel Plate]], [[Reinforced Glass]], `#bioforge:ingredients/minecraft/gold_ingot`, [[Precision Mechanism]] → 1 × Laboratory Frame.
...
- Used to produce: [[Centrifuge]], [[Chemical Synthesizer]], [[Microscope]], [[Pharma Mixer]], [[Sterilization Chamber]], [[Vaccine Maker]].
...
- Registry ID: `bioforge:laboratory_frame`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/laboratory_frame`.
