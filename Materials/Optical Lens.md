...
- **crafting shaped** (`optical_lens.json`): `#bioforge:ingredients/minecraft/quartz`, [[Reinforced Glass]], `#bioforge:ingredients/minecraft/amethyst_shard` → 2 × Optical Lens.
...
- Used to produce: [[Area Contamination Scanner]], [[Cas PAM Module]], [[Microscope]], [[Otoscope]], [[Pulse Oximeter]].
...
- Registry ID: `bioforge:optical_lens`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/optical_lens`.
