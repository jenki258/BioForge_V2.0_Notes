...
Despite its legacy registry ID `iron_needle`, this is the standard Black Steel Needle.
## Obtaining

- **crafting shaped** (`iron_needle.json`): [[Black Steel Nugget]], [[Black Steel Plate]], [[Sterilizing Solution]] → 1 × Black Steel Needle.
...
- Used to produce: [[Hardened Needle]].
...
- Registry ID: `bioforge:iron_needle`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/iron_needle`.
