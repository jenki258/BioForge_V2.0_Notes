...
- **crafting shaped** (`otoscope.json`): [[Optical Lens]], [[Black Steel Plate]], `#bioforge:ingredients/minecraft/redstone_torch`, [[Black Steel Nugget]] → 1 × Otoscope.

## Function

- **tooltip.hold:** Hold right-click to activate the otoscope
- **tooltip.target:** Look at an entity to inspect it (Needs mirror in off-hand to check yourself)
- **tooltip.move:** Use arrow keys / WASD to move the selector
- **tooltip.exit:** Release right-click to close
