...
- **crafting shaped** (`mirror.json`): [[Reinforced Glass]], [[Black Steel Plate]], [[Black Steel Nugget]] → 1 × Mirror.

## Function

- **tooltip:** Hold in off-hand with Otoscope to inspect yourself
