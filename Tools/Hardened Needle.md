...
It is the durable late needle tier upgraded with netherite, diamond, and sterile chemistry.
## Obtaining

- **crafting shapeless** (`hardened_needle.json`): [[Black Steel Needle]], `#bioforge:ingredients/minecraft/netherite_scrap`, `#bioforge:ingredients/minecraft/diamond`, [[Sterilizing Solution]] → 1 × Hardened Needle.
...
- Registry ID: `bioforge:hardened_needle`.
