...
> Definition ID: `bioforge:lung_sound`. Value type: `enum`.

## Meaning

NORMAL or CRACKLE; crackles identify respiratory involvement and interact with shedding/cough behavior.
