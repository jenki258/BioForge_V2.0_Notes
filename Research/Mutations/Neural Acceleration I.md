...
Faster motor signalling grants Speed I

## Gameplay behavior

- Apply `minecraft:speed` level 1 for 140 ticks every 80 ticks on continuous.
...
- Behavior tags: `beneficial`, `simple_effect`, `speed`, `tier_1`.
