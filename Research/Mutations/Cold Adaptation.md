...
> Mutation ID: `cold_adaptation`. Source: `data/bioforge/mutations/lifecycle_mutations.json`.

## Description

Natural selection has made the strain stable in cold climates
...
- Behavior tags: `climate_adaptation`, `cold_immunity`.
