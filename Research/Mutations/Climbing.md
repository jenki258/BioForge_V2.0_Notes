...
> Mutation ID: `climbing`. Source: `data/bioforge/mutations/legacy_v1_catalog.json`.

## Description

Altered muscle control allows the host to climb vertical surfaces

## Gameplay behavior

- Allow wall climbing every 1 ticks on continuous.
