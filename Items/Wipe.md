...
#BioForge #BioForge_V0_54T #Item #Items #PlayerGuide #ModpackGuide #AddonDevelopment

> Documentation status: implemented in V0.54T.

## Overview

Wipe is registered BioForge content.

## Obtaining

- **crafting shapeless** (`wipes.json`): `#bioforge:ingredients/minecraft/paper`, `#bioforge:ingredients/minecraft/white_wool`, [[Sterilizing Solution]] → 8 × Wipe.
