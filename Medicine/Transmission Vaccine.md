...
It adds or removes one programmed route from the matching infection.
## Obtaining

- **crafting shapeless** (`transmission_vaccine.json`): [[Strain Vaccine]], `#bioforge:ingredients/minecraft/feather`, `#bioforge:ingredients/minecraft/redstone`, [[Sterile Polymer Sheet]] → 1 × Transmission Vaccine.
...
- Registry ID: `bioforge:transmission_vaccine`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/transmission_vaccine`.
