...
- **crafting shapeless** (`anti_d_vial.json`): [[Laboratory Glassware]], [[Sterilizing Solution]], `#bioforge:ingredients/minecraft/ghast_tear`, `#bioforge:ingredients/minecraft/white_dye`, `#bioforge:ingredients/minecraft/quartz` → 1 × Anti-D Reagent.
...
- Registry ID: `bioforge:anti_d_vial`.
