...
- **crafting shapeless** (`anti_b_vial.json`): [[Laboratory Glassware]], [[Sterilizing Solution]], `#bioforge:ingredients/minecraft/spider_eye`, `#bioforge:ingredients/minecraft/blue_dye`, `#bioforge:ingredients/minecraft/copper_ingot` → 1 × Anti-B Reagent.
...
- Registry ID: `bioforge:anti_b_vial`.
