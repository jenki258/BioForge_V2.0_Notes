...
It is the entry temporary resistance tier and reduces establishment chance without curing.
## Obtaining
...
- Registry ID: `bioforge:viral_suppressor_pill`.
