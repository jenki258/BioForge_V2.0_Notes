...
- **crafting shapeless** (`anti_a_vial.json`): [[Laboratory Glassware]], [[Sterilizing Solution]], `#bioforge:ingredients/minecraft/spider_eye`, `#bioforge:ingredients/minecraft/red_dye`, `#bioforge:ingredients/minecraft/copper_ingot` → 1 × Anti-A Reagent.
...
- Registry ID: `bioforge:anti_a_vial`.
