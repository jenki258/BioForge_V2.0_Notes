...
- **crafting shaped** (`airtight_seal.json`): [[Black Steel Nugget]], [[Sterile Rubber]] → 2 × Airtight Seal.
...
- Used to produce: [[HazCure Boots]], [[HazCure Helmet]], [[HazCure Leggings]].
...
- Registry ID: `bioforge:airtight_seal`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/airtight_seal`.
