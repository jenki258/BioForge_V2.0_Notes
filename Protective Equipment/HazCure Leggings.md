...
- **crafting shaped** (`hazcure_leggings.json`): [[Ice Bag Harness]], [[Magma Bag Harness]], [[Insulated Lining]], [[Sealed Biofabric]], [[Airtight Seal]] → 1 × HazCure Leggings.
...
- Registry ID: `bioforge:hazcure_leggings`.
