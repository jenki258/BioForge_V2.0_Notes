...
- **crafting shaped** (`hazcure_helmet.json`): [[Airtight Seal]], [[Activated Biofilter]], [[Sealed Biofabric]], [[Medical Mask]], [[Black Steel Plate]] → 1 × HazCure Helmet.
...
- Registry ID: `bioforge:hazcure_helmet`.
