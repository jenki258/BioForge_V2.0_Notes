...
- **crafting shaped** (`hazcure_chestplate.json`): [[Sealed Biofabric]], [[Black Steel Mesh]], [[Protective Gloves]], [[Chemical-Resistant Coating]] → 1 × HazCure Chestpiece.
...
- Registry ID: `bioforge:hazcure_chestplate`.
