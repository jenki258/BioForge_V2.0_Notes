...
- **crafting shaped** (`respirator_valve.json`): [[Sterile Rubber]], [[Black Steel Plate]], [[Precision Mechanism]] → 1 × Respirator Valve.
...
- Registry ID: `bioforge:respirator_valve`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/respirator_valve`.
