...
- **crafting shapeless** (`chemical_resistant_coating.json`): [[Polymer Resin]], [[Ethanol]], [[Sulfuric Acid]], `#bioforge:ingredients/minecraft/clay_ball` → 2 × Chemical-Resistant Coating.
...
- Used to produce: [[HazCure Chestpiece]], [[Protective Gloves]], [[Sealed Biofabric]].
...
- Registry ID: `bioforge:chemical_resistant_coating`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/chemical_resistant_coating`.
