...
- **crafting shapeless** (`sterile_rubber.json`): `#bioforge:ingredients/minecraft/slime_ball`, `#bioforge:ingredients/minecraft/dried_kelp`, [[Sulfuric Acid]], [[Sterilizing Solution]] → 2 × Sterile Rubber.
- **[[Sterilization Chamber]]** (`sterile_rubber.json`): `#bioforge:ingredients/minecraft/slime_ball` → 1 × Sterile Rubber in 150 ticks.
...
- Used to produce: [[Airtight Seal]], [[Protective Gloves]], [[Respirator Valve]].
...
- Registry ID: `bioforge:sterile_rubber`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/sterile_rubber`.
