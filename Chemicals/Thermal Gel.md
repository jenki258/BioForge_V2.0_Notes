...
- **crafting shapeless** (`thermal_gel.json`): `#bioforge:ingredients/minecraft/snowball`, `#bioforge:ingredients/minecraft/magma_cream`, `#bioforge:ingredients/minecraft/slime_ball`, [[Sterilizing Solution]] → 2 × Thermal Gel.
- **[[Chemical Synthesizer]]** (`thermal_gel.json`): `#bioforge:ingredients/minecraft/snowball`, `#bioforge:ingredients/minecraft/magma_cream`, `#bioforge:ingredients/minecraft/slime_ball` → 3 × Thermal Gel in 180 ticks.
...
- Used to produce: [[Ice Bag Harness]], [[Insulated Lining]], [[Magma Bag Harness]].
...
- Registry ID: `bioforge:thermal_gel`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/thermal_gel`.
