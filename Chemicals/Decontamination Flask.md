...
Throw it to remove surface contamination and reduce airborne reservoirs in its configured area.
## Obtaining

- **crafting shapeless** (`decontamination_flask.json`): [[Neutralizing Agent]], [[Surfactant Concentrate]], [[Sterilizing Solution]], `#bioforge:ingredients/minecraft/splash_potion` → 1 × Decontamination Flask.
...
- Registry ID: `bioforge:decontamination_flask`.
