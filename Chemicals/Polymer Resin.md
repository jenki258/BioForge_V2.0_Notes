...
- **crafting shapeless** (`polymer_resin.json`): `#bioforge:ingredients/minecraft/slime_ball`, [[Activated Carbon]], [[Sulfuric Acid]] → 2 × Polymer Resin.
- **[[Chemical Synthesizer]]** (`polymer_resin.json`): `#bioforge:ingredients/minecraft/slime_ball`, [[Activated Carbon]], [[Sulfuric Acid]] → 3 × Polymer Resin in 160 ticks.
...
- Used to produce: [[Chemical-Resistant Coating]], [[Sterile Polymer Sheet]].
...
- Registry ID: `bioforge:polymer_resin`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/polymer_resin`.
