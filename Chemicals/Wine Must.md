...
The Barrel Press produces this distinct fruit extract for ethanol synthesis.
## Obtaining

- **[[Barrel Press]]** (`wine_must.json`): `#bioforge:ingredients/minecraft/pressable_fruits`, `#bioforge:ingredients/minecraft/pressable_fruits`, `#bioforge:ingredients/minecraft/pressable_fruits`, `#bioforge:ingredients/minecraft/glass_bottle` → 2 × Wine Must in 120 ticks.
...
- Registry ID: `bioforge:wine_must`.
- Preferred ingredient tag: `#bioforge:ingredients/bioforge/wine_must`.
